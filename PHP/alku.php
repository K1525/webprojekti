...
require_once '/home/H8851/php-password-lib/PasswordLib.phar';
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>"
style=color:#000;background-color:#eeeeee>
Jos sinulla ei ole tunnusta, voit myos rekisteroitya:
    <a href="rekisterointisivu.php">
<input type='submit' name='action'  value='siirry rekisteroitymaan' onclick='this.form.action="/rekisterointisivu" </a>  
<br>
</form>
