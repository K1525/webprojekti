...
function add_product_to_db($db){
    $sql = "INSERT INTO product (Name, Price, Stock, Description, 
Description_more, Gender, category_CategoryId) 
    VALUES (:Name, :Price, :Stock, :Description, :Description_more, 
    :Gender, :Category)";
    ...
    $description = (isset($p['3']) && !empty($p['3'])) ? $_POST['3'] : null;
    $description_more = (isset($p['4']) && !empty($p['4'])) ? $_POST['4'] : null;
